...
const Dashboard = ({ expenses, salary, categories }) => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-semibold mb-6 text-indigo-800">Dashboard</h2>
      <AnimatedCard>
        <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Summary</h3>
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="bg-blue-100 p-4 rounded-lg">
            <p className="text-sm text-blue-800">Monthly Salary</p>
            <p className="text-2xl font-bold text-blue-600">${salary.toFixed(2)}</p>
          </div>
      ...
      <AnimatedCard>
        <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Expense Distribution</h3>
      ...
      <AnimatedCard>
        <h3 className="text-2xl font-semibold mb-4 text-indigo-700">Monthly Expense Breakdown</h3>
        <ResponsiveContainer width="100%" height={300}>
    ...
    <Router>
      <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-200 relative overflow-hidden">
        ...
        <div className="relative z-10 p-6 max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-center text-indigo-900">Expense Tracker</h1>
          <nav className="mb-8">
